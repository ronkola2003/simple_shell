...
/**
 * handle_ctrl_c - Prints the prompt in a new line when the signal SIGINT (control C) is sent to the program
 * @opr UNUSED: Unused parameter in the function prototype
 */
...
/**
 * initialize_data - Initializes struct with program information
 * @data: Pointer to the data struct
 * @argv: Array of arguments passed to program execution
 * @env: Environment passed to program execution
 * @argc: Number of values received from the command line
 */
...
/**
 * sisifo - Infinite loop that displays the prompt
